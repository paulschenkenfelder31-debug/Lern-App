'use strict';
const SHELL='fahrklar-shell-v2',DATA='fahrklar-data-v1',IMAGES='fahrklar-images-v1';
const FILES=['/','/index.html','/app.js','/core.js','/icons.js','/style.css','/firebase-config.js','/cloud.js','/web-bridge.js','/manifest.webmanifest','/icon.svg','/icon-192.png','/icon-512.png'];
